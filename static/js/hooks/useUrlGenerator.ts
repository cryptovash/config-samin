...
import { useFullLendingPool } from './useData';
...
export function useAddLiquidityUrl() : string {
  ...
  if (dex.id === DEX.GLACIER) {
    return dex.addLiquidityUrl;
  }
  if (dex.id === DEX.SATIN) {
    return dex.addLiquidityUrl;
  }
  if (dex.id === DEX.EQUILIBRE) {
    return dex.addLiquidityUrl;
  }
  if (dex.id === DEX.VELOCIMETER) {
    return dex.addLiquidityUrl;
  }
  if (dex.id === DEX.THENA) {
    return dex.addLiquidityUrl;
  }
  if (dex.id === DEX.SOLIDLIZARD) {
    return dex.addLiquidityUrl;
  }
  if (dex.id === DEX.RAMSES) {
    return dex.addLiquidityUrl;
  }
  if (dex.id === DEX.STERLING) {
    return dex.addLiquidityUrl;
  }
  if (dex.id === DEX.SOLIDLY_V2) {
    return dex.addLiquidityUrl;
  }
  if (dex.id === DEX.EQUALIZER) {
    return dex.addLiquidityUrl + lpAddress.toLowerCase();
  }
  if (dex.id === DEX.EQUALIZERV2) {
    return dex.addLiquidityUrl + lpAddress.toLowerCase();
  }
