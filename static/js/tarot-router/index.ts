...
import SpookyV3VaultTokenJSON from 'abis/contracts/ISpookyV3VaultToken.json';
...
import ArbidexMasterChefJSON from 'abis/contracts/IArbidexMasterChef.json';
import ArbidexVaultTokenJSON from 'abis/contracts/IArbidexVaultToken.json';
...
class TarotRouter {
  ...
  newArbidexVaultToken(address: Address): Contract {
    return new Contract(address, ArbidexVaultTokenJSON, this.readLibrary);
  }
  ...
  newSpookyV3VaultToken(address: Address): Contract {
    return new Contract(address, SpookyV3VaultTokenJSON, this.readLibrary);
  }
  ...
  newArbidexMasterChef(address: Address): Contract {
    return new Contract(address, ArbidexMasterChefJSON, this.readLibrary);
  }
