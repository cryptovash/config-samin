...
const LendingPoolCard = ({
  ...
  const isDexTypeSolidly = [DEX.SOLIDLY, DEX.SPIRIT_V2, DEX.VELODROME, DEX.GLACIER, DEX.SATIN, DEX.EQUALIZERV2, DEX.EQUILIBRE, DEX.VELOCIMETER, DEX.THENA, DEX.XCAL, DEX.SOLIDLIZARD, DEX.RAMSES, DEX.STERLING, DEX.SOLIDLY_V2].includes(dex.id);
