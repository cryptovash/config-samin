...
export const getTokenSymbol = (lendingPoolId: string, poolTokenType = PoolTokenType.Collateral) : string => {
  ...
  if (poolTokenType === PoolTokenType.Collateral) {
    ...
    const isDexTypeSolidly = [DEX.SOLIDLY, DEX.SPIRIT_V2, DEX.VELODROME, DEX.GLACIER, DEX.SATIN, DEX.EQUALIZERV2, DEX.EQUILIBRE, DEX.VELOCIMETER, DEX.XCAL, DEX.SOLIDLIZARD, DEX.RAMSES, DEX.STERLING, DEX.THENA, DEX.SOLIDLY_V2].includes(poolDetails.dex);
