    ...
    [
      ...
      },
      {
        ...
        value: function onMove(e, position, dragTrack, startBounds) {
          ...
          if (dragTrack) {
            ...
            var ratio = Math.min(
              Math.max(pos / (this.getSliderLength() / 100), min),
              max
            );
      ...
      },
      {
        ...
        value: function onKeyboard(e) {
          ...
          var valueMutator = utils.getKeyboardValueMutator(
            e,
            vertical,
            reverse
          );
          ...
          var handles = bounds.map(function (v, i) {
            ...
            return handleGenerator({
              className: classNames(
                ((_classNames = {}),
                _defineProperty(_classNames, handleClassName, true),
                _defineProperty(
                  _classNames,
