...
export default function createSlider(Component) {
  ...
  return (
    (_a = /*#__PURE__*/ (function (_Component) {
      ...
      function ComponentEnhancer(props) {
        ...
        _this.onDown = function (e, position) {
          ...
          var value =
            draggableTrack && _this.positionGetValue
        ...
        var step = props.step,
          max = props.max,
          min = props.min;
        var isPointDiffEven = isFinite(max - min)
          ? (max - min) % step === 0
        ...
        warning(
          ...
          "Slider[max] - Slider[min] ("
            .concat(max - min, ") should be a multiple of Slider[step] (")
            .concat(step, ")")
        );
        _this.handlesRefs = {};
        return _this;
      ...
      _createClass(ComponentEnhancer, [
        ...
        },
        {
          ...
          value: function componentWillUnmount() {
            if (
              _get(
                _getPrototypeOf(ComponentEnhancer.prototype),
        ...
        },
        {
          ...
          value: function focus() {
            ...
            (_this$handlesRefs$ = this.handlesRefs[0]) === null ||
        ...
        },
        {
          ...
          value: function blur() {
            ...
            Object.keys(this.handlesRefs).forEach(function (key) {
              ...
              (_this2$handlesRefs$ke = _this2.handlesRefs[key]) === null ||
              _this2$handlesRefs$ke === void 0
                ? void 0
                : (_this2$handlesRefs$ke2 = _this2$handlesRefs$ke.blur) ===
                    null || _this2$handlesRefs$ke2 === void 0
                ? void 0
          ...
          value: function render() {
            ...
            return /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement("div", {
                ...
                style: _objectSpread(
                  _objectSpread({}, maximumTrackStyle),
                  railStyle
                ),
              }),
              tracks,
    ...
    (_a.displayName = "ComponentEnhancer(".concat(Component.displayName, ")")),
    (_a.defaultProps = _objectSpread(
      _objectSpread({}, Component.defaultProps),
      {},
      {
        prefixCls: "rc-slider",
        className: "",
