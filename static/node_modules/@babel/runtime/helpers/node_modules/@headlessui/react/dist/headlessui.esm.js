...
var yt = { serverHandoffComplete: !1 };
function q() {
  let [e, t] = er(yt.serverHandoffComplete);
  return (
    eo(() => {
      e !== !0 && t(!0);
    }, [e]),
...
function E({
  ...
  if (a & 1) {
    ...
    return S(l ? 0 : 1, {
      ...
      [1]() {
        return _e({ ...s, hidden: !0, style: { display: "none" } }, t, r, i);
      },
    });
  }
  return _e(e, t, r, i);
...
function _e(e, t = {}, r, o) {
  ...
  if (
    ...
    n === oo && Object.keys(l).length > 0)
  ) {
    if (!cr(u) || (Array.isArray(u) && u.length > 1))
      throw new Error(
        [
...
`)
    ...
    return ur(
      u,
      Object.assign({}, fr(mr(gt(l, ["ref"])), u.props, ["onClick"]), s)
    );
  }
      ...
      switch (e.focus) {
        ...
        case 1: {
          let a = r
            ...
            .reverse()
            .findIndex((l, s, u) =>
              n !== -1 && u.length - s - 1 >= n ? !1 : !t.resolveDisabled(l)
            );
        ...
        case 3: {
          let a = r
            .slice()
            .reverse()
            .findIndex((l) => !t.resolveDisabled(l));
          return a === -1 ? a : r.length - 1 - a;
        }
        case 4:
...
function W({ value: e, children: t }) {
  return Pr.createElement(Pt.Provider, { value: e }, t);
}
...
function se({ container: e, accept: t, walk: r, enabled: o = !0 }) {
  ...
  Er(() => {
    ...
    x(() => {
      ...
      let a = n.current,
        l = i.current,
        s = Object.assign((c) => a(c), { acceptNode: a }),
...
var Ar = {
    [1](e) {
      return e.disabled || e.comboboxState === 1
        ? e
        : { ...e, activeOptionIndex: null, comboboxState: 1 };
    },
    [0](e) {
      return e.disabled || e.comboboxState === 0
        ? e
        : { ...e, comboboxState: 0 };
    },
    [2](e, t) {
    ...
    [4]: (e, t) => {
      var i;
      let r =
          e.activeOptionIndex !== null ? e.options[e.activeOptionIndex] : null,
        o = Array.from(
          (i = e.optionsRef.current) == null
            ? void 0
            : i.querySelectorAll('[id^="headlessui-combobox-option-"]')
        ).reduce((a, l, s) => Object.assign(a, { [l.id]: s }), {}),
        n = [...e.options, { id: t.id, dataRef: t.dataRef }].sort(
          (a, l) => o[a.id] - o[l.id]
        );
      return {
        ...e,
    ...
    [5]: (e, t) => {
      ...
      return (
        n !== -1 && r.splice(n, 1),
        {
          ...
          options: r,
          activeOptionIndex: (() =>
            n === e.activeOptionIndex || o === null ? null : r.indexOf(o))(),
        }
      );
    },
  },
...
var Or = Cr,
  Ir = D(function (t, r) {
    let { value: o, onChange: n, disabled: i = !1, ...a } = t,
      l = He({ value: o, onChange: n }),
      s = He({ static: !1, hold: !1 }),
      u = He({ displayValue: void 0 }),
      c = Sr(hr, {
        comboboxState: 1,
        comboboxPropsRef: l,
        optionsPropsRef: s,
    ...
    x(() => {
      ...
      x(() => d({ type: 2, disabled: i }), [i]),
      w("mousedown", (O) => {
        var N, K, V;
        let L = O.target;
        m === 0 &&
          (((N = f.current) == null ? void 0 : N.contains(L)) ||
            ((K = p.current) == null ? void 0 : K.contains(L)) ||
            ((V = y.current) == null ? void 0 : V.contains(L)) ||
            d({ type: 1 }));
      });
    let P = T === null ? null : b[T].dataRef.current.value,
      C = oe(
        () => ({ open: m === 0, disabled: i, activeIndex: T, activeOption: P }),
        [m, i, b, T]
      ),
      R = B(() => {
        ...
        typeof O == "function"
          ? (p.current.value = O(o))
          : typeof o == "string" && (p.current.value = o);
      }, [o, p, u]),
      g = B(
        (O) => {
      ...
      h = oe(() => ({ selectOption: g, selectActiveOption: v }), [g, v]);
    return (
      x(() => {
        m === 1 && R();
      }, [R, m]),
  ...
  Dr = D(function (t, r) {
    var R, g;
    let { value: o, onChange: n, displayValue: i, ...a } = t,
    ...
    let p = B(
      ...
      P = oe(
        () => ({ open: l.comboboxState === 0, disabled: l.disabled }),
        [l]
      ),
      C = {
        ref: c,
        ...
        "aria-activedescendant":
          ...
          (g = l.options[l.activeOptionIndex]) == null
            ? void 0
            : g.id,
        "aria-labelledby": d,
        disabled: l.disabled,
            ...
            case "ArrowDown":
              return (
                ...
                o.comboboxState === 1 &&
                  (n({ type: 0 }),
                  s.nextFrame(() => {
                    o.comboboxPropsRef.current.value ||
                      n({ type: 3, focus: 0 });
                  })),
                s.nextFrame(() => {
                  var d;
                  return (d = o.inputRef.current) == null
                    ? void 0
...
function kr(e) {
  let [t] = pe("Combobox.Label"),
    ...
    o = B(() => {
      var a;
      return (a = t.inputRef.current) == null
        ? void 0
        : a.focus({ preventScroll: !0 });
    }, [t.inputRef]),
    n = oe(() => ({ open: t.comboboxState === 0, disabled: t.disabled }), [t]),
    i = { ref: t.labelRef, id: r, onClick: o };
  return E({
    props: { ...e, ...i },
    slot: n,
    defaultTag: wr,
  ...
  Hr = D(function (t, r) {
    ...
    x(() => {
      ...
      se({
        ...
        accept(p) {
          return p.getAttribute("role") === "option"
    ...
    let m = ee(() => {
        var p, f, d;
        return (d = (p = i.labelRef.current) == null ? void 0 : p.id) != null
          ? d
          : (f = i.buttonRef.current) == null
          ? void 0
          : f.id;
      }, [i.labelRef.current, i.buttonRef.current]),
      b = oe(() => ({ open: i.comboboxState === 0 }), [i]),
      T = {
        "aria-activedescendant":
          i.activeOptionIndex === null ||
          (y = i.options[i.activeOptionIndex]) == null
            ? void 0
            : y.id,
        "aria-labelledby": m,
        role: "listbox",
...
function Br(e) {
  ...
  x(() => {
    ...
    x(() => {
      ...
      c.current.textValue =
        (C =
          (P = document.getElementById(l)) == null ? void 0 : P.textContent) ==
        null
          ? void 0
          : C.toLowerCase();
    }, [c, l]);
  let m = B(() => a.selectOption(l), [a, l]);
  x(
    () => (i({ type: 4, id: l, dataRef: c }), () => i({ type: 5, id: l })),
    [c, l]
  ),
    x(() => {
    ...
    x(() => {
      ...
      return (
        P.requestAnimationFrame(() => {
          var C, R;
          (R =
            (C = document.getElementById(l)) == null
              ? void 0
              : C.scrollIntoView) == null || R.call(C, { block: "nearest" });
        }),
        P.dispose
      );
  ...
  let b = B(
      (P) => {
        ...
        m(),
          ...
          k().nextFrame(() => {
            var C;
            return (C = n.inputRef.current) == null
              ? void 0
    ...
    f = oe(() => ({ active: s, selected: u, disabled: t }), [s, u, t]);
  return E({
    props: {
      ...o,
      ...{
...
function Ne(e, t = 30, { initialFocus: r, containers: o } = {}) {
  let n = uo(typeof window != "undefined" ? document.activeElement : null),
    i = uo(null),
    a = Be(),
    l = Boolean(t & 16),
    s = Boolean(t & 2);
  St(() => {
    ...
    w("keydown", (u) => {
      !(t & 4) ||
        ...
        (u.key === "Tab" &&
          (u.preventDefault(),
          M(e.current, (u.shiftKey ? 2 : 4) | 16) === 2 &&
            (i.current = document.activeElement)));
    }),
    w(
      "focus",
      (u) => {
        ...
        b && b instanceof HTMLElement
          ? Kr(c, b)
            ? ((i.current = b), ce(b))
            : (u.preventDefault(), u.stopPropagation(), ce(m))
          : ce(i.current);
      },
      !0
    );
...
function At(e) {
  return jr.createElement(mo.Provider, { value: e.force }, e.children);
}
function Xr() {
  let e = bo(),
    t = zr(Po),
...
function We(e) {
  ...
  return (
    ...
    n
      ? !r || !o
        ? null
        : Yr(E({ props: t, defaultTag: Jr, name: "Portal" }), o)
      : null
  );
}
var Zr = To,
...
function en(e) {
  ...
  return Qr.createElement(
    Po.Provider,
    { value: t },
    E({ props: r, defaultTag: Zr, name: "Popover.Group" })
  );
}
We.Group = en;
import tn, {
    ...
    xo(
      () =>
        function (o) {
          ...
          return tn.createElement(vo.Provider, { value: i }, o.children);
        },
      [t]
    ),
  ];
...
function Eo({ children: e, onUpdate: t, type: r, element: o }) {
  ...
  return (
    x(() => (i(0, r, o), () => i(1, r, o)), [i, r, o]),
    sn.createElement(ht.Provider, { value: i }, e)
  );
}
var yn = {
    [0](e, t) {
...
function It(e) {
  ...
  if (t === null) {
    let r = new Error(
      `<${e} /> is missing a parent <${An.displayName} /> component.`
    );
...
var Pn = "div",
  xn = 1 | 2,
  vn = D(function (t, r) {
    let { open: o, onClose: n, initialFocus: i, ...a } = t,
      [l, s] = Tn(0),
      u = _();
    o === void 0 && u !== null && (o = S(u, { [0]: !0, [1]: !1 }));
    let c = So(new Set()),
      m = So(null),
      b = I(m, r),
    ...
    let p = o ? 0 : 1,
      f = (() => (u !== null ? u === 0 : p === 0))(),
      [d, P] = bn(gn, { titleId: null, descriptionId: null }),
      C = Ke(() => n(!1), [n]),
      R = Ke((F) => P({ type: 0, id: F }), [P]),
      v = q() && p === 0,
      h = l > 1,
      O = Co(Ve) !== null;
    Ne(m, v ? S(h ? "parent" : "leaf", { parent: 16, leaf: 30 }) : 1, {
      initialFocus: i,
      containers: c,
    }),
      fo(m, h ? v : !1),
      w("mousedown", (F) => {
        ...
        let $ = F.target;
        p === 0 &&
          (h || ((H = m.current) == null ? void 0 : H.contains($)) || C());
      }),
      w("keydown", (F) => {
        F.key === "Escape" &&
          p === 0 &&
          (h || (F.preventDefault(), F.stopPropagation(), C()));
      }),
      Ot(() => {
        if (p !== 0 || O) return;
        ...
        return (
          ...
          (document.documentElement.style.paddingRight = `${H}px`),
          () => {
            (document.documentElement.style.overflow = F),
              (document.documentElement.style.paddingRight = $);
          }
        );
      }, [p, O]),
      Ot(() => {
        ...
        let F = new IntersectionObserver(($) => {
          for (let H of $)
            H.boundingClientRect.x === 0 &&
              H.boundingClientRect.y === 0 &&
              H.boundingClientRect.width === 0 &&
              H.boundingClientRect.height === 0 &&
              C();
        });
    ...
    let [N, K] = re(),
      ...
      Fe = je(
        () => [{ dialogState: p, close: C, setTitleId: R }, d],
        [p, d, C, R]
      ),
      ge = je(() => ({ open: p === 0 }), [p]),
      we = {
  ...
  Rn = "div",
  En = D(function (t, r) {
    let [{ dialogState: o, close: n }] = It("Dialog.Overlay"),
      i = I(r),
      ...
      s = je(() => ({ open: o === 0 }), [o]);
    return E({
      props: { ...t, ...{ ref: i, id: a, "aria-hidden": !0, onClick: l } },
      slot: s,
      defaultTag: Rn,
      name: "Dialog.Overlay",
    });
  ...
  Cn = "h2";
function Sn(e) {
  let [{ dialogState: t, setTitleId: r }] = It("Dialog.Title"),
...
function Ye(e) {
  ...
  qe(() => l({ type: 2, buttonId: o }), [o, l]),
    qe(() => l({ type: 3, panelId: n }), [n, l]);
  let s = Qe(
      (m) => {
        l({ type: 1 });
        let b = (() =>
  ...
  return $e.createElement(
    ...
    $e.createElement(
      ...
      $e.createElement(
        W,
        { value: S(a, { [0]: 0, [1]: 1 }) },
        E({ props: r, slot: c, defaultTag: Fn, name: "Disclosure" })
      )
    )
  );
}
var wn = "button",
  kn = D(function (t, r) {
    let [o, n] = Ft("Disclosure.Button"),
            ...
            switch (f.key) {
              ...
              case "Enter":
                f.preventDefault(),
                  f.stopPropagation(),
                  n({ type: 0 }),
                  (d = document.getElementById(o.buttonId)) == null ||
                    d.focus();
                break;
            }
          } else
      ...
      b = ze(() => ({ open: o.disclosureState === 0 }), [o]),
      T = U(t, i),
      y = t,
      p = s
        ? { ref: a, type: T, onKeyDown: u, onClick: m }
        : {
            ref: a,
            id: o.buttonId,
            type: T,
  ...
  Hn = D(function (t, r) {
    ...
    qe(() => () => n({ type: 5 }), [n]),
      qe(() => {
        var b;
        o.disclosureState === 1 &&
          ((b = t.unmount) != null ? b : !0) &&
          n({ type: 5 });
      }, [o.disclosureState, t.unmount, n]);
    let u = ze(() => ({ open: o.disclosureState === 0, close: i }), [o, i]),
      c = { ref: a, id: o.panelId },
      m = t;
    return $e.createElement(
      kt.Provider,
      { value: o.panelId },
...
function yu(e) {
  let t = Un(null),
    ...
    n = q();
  return (
    Ne(t, n ? 30 : 1, { initialFocus: r }),
    E({ props: { ...o, ...{ ref: t } }, defaultTag: Bn, name: "FocusTrap" })
  );
}
import Oo, {
  Fragment as Nn,
...
var $n = {
    [1](e) {
      return e.disabled || e.listboxState === 1
        ? e
    ...
    [4](e, t) {
      ...
      return e.searchQuery === "" && e.activeOptionIndex === r
        ? e
        : { ...e, searchQuery: "", activeOptionIndex: r };
    },
    [5]: (e, t) => {
      if (e.disabled || e.listboxState === 1) return e;
      let o = e.searchQuery !== "" ? 0 : 1,
        ...
        a = (
          ...
          return (
            ...
            ((u = s.dataRef.current.textValue) == null
              ? void 0
              : u.startsWith(n))
          );
        }),
      ...
      return l === -1 || l === e.activeOptionIndex
        ? { ...e, searchQuery: n }
        : { ...e, searchQuery: n, activeOptionIndex: l };
    },
    [6](e) {
      return e.disabled || e.listboxState === 1 || e.searchQuery === ""
        ? e
        : { ...e, searchQuery: "" };
    },
    [7]: (e, t) => {
      var n;
      let r = Array.from(
          (n = e.optionsRef.current) == null
            ? void 0
            : n.querySelectorAll('[id^="headlessui-listbox-option-"]')
        ).reduce((i, a, l) => Object.assign(i, { [a.id]: l }), {}),
        o = [...e.options, { id: t.id, dataRef: t.dataRef }].sort(
          (i, a) => r[i.id] - r[a.id]
        );
      return { ...e, options: o };
    },
...
var qn = Nn;
function Ee(e) {
  let { value: t, onChange: r, disabled: o = !1, horizontal: n = !1, ...i } = e,
  ...
  x(() => {
    ...
    x(() => b({ type: 2, disabled: o }), [o]),
    x(() => b({ type: 3, orientation: a }), [a]),
    w("mousedown", (y) => {
      var f, d, P;
      let p = y.target;
      s === 0 &&
        (((f = m.current) == null ? void 0 : f.contains(p)) ||
          ((d = c.current) == null ? void 0 : d.contains(p)) ||
          (b({ type: 1 }),
          de(p, 1) ||
            (y.preventDefault(), (P = m.current) == null || P.focus())));
    });
  let T = ve(() => ({ open: s === 0, disabled: o }), [s, o]);
  return Oo.createElement(
    ...
    Oo.createElement(
      W,
      { value: S(s, { [0]: 0, [1]: 1 }) },
      E({ props: i, slot: T, defaultTag: qn, name: "Listbox" })
    )
  );
}
var zn = "button",
  Yn = D(function (t, r) {
    ...
    let [o, n] = Re("Listbox.Button"),
        ...
        (f) => {
          ...
          o.listboxState === 0
            ? (n({ type: 1 }),
              l.nextFrame(() => {
                var d;
                return (d = o.buttonRef.current) == null
                  ? void 0
                  : d.focus({ preventScroll: !0 });
              }))
            : (f.preventDefault(), n({ type: 0 }));
      ...
      b = ve(() => ({ open: o.listboxState === 0, disabled: o.disabled }), [o]),
      T = t,
      y = {
        ref: i,
        id: a,
...
function Jn(e) {
  let [t] = Re("Listbox.Label"),
    ...
    o = z(() => {
      var a;
      return (a = t.buttonRef.current) == null
        ? void 0
        : a.focus({ preventScroll: !0 });
    }, [t.buttonRef]),
    n = ve(() => ({ open: t.listboxState === 0, disabled: t.disabled }), [t]),
    i = { ref: t.labelRef, id: r, onClick: o };
  return E({
    props: { ...e, ...i },
    slot: n,
...
var Zn = "ul",
  ...
  ti = D(function (t, r) {
    ...
    let m = z(
        (d) => {
          switch ((s.dispose(), d.key)) {
            ...
            case "Enter":
              ...
              k().nextFrame(() => {
                var P;
                return (P = o.buttonRef.current) == null
                  ? void 0
      ...
      b = ee(() => {
        var d, P, C;
        return (C = (d = o.labelRef.current) == null ? void 0 : d.id) != null
          ? C
          : (P = o.buttonRef.current) == null
          ? void 0
          : P.id;
      }, [o.labelRef.current, o.buttonRef.current]),
      T = ve(() => ({ open: o.listboxState === 0 }), [o]),
      y = {
        "aria-activedescendant":
          o.activeOptionIndex === null ||
          (f = o.options[o.activeOptionIndex]) == null
            ? void 0
            : f.id,
        "aria-labelledby": b,
...
function ri(e) {
  let { disabled: t = !1, value: r, ...o } = e,
    ...
    l =
      n.activeOptionIndex !== null
        ? n.options[n.activeOptionIndex].id === a
        : !1,
    s = n.propsRef.current.value === r,
    u = Vn({ disabled: t, value: r });
  x(() => {
    ...
    x(() => {
      ...
      u.current.textValue =
        (P =
          (d = document.getElementById(a)) == null ? void 0 : d.textContent) ==
        null
          ? void 0
          : P.toLowerCase();
    }, [u, a]);
  let c = z(() => n.propsRef.current.onChange(r), [n.propsRef, r]);
  x(
    () => (i({ type: 7, id: a, dataRef: u }), () => i({ type: 8, id: a })),
    [u, a]
  ),
    x(() => {
      var d, P;
      n.listboxState === 0 &&
        (!s ||
          ...
          (P = (d = document.getElementById(a)) == null ? void 0 : d.focus) ==
            null || P.call(d)));
    }, [n.listboxState]),
    x(() => {
      ...
      return (
        d.requestAnimationFrame(() => {
          var P, C;
          (C =
            (P = document.getElementById(a)) == null
              ? void 0
              : P.scrollIntoView) == null || C.call(P, { block: "nearest" });
        }),
        d.dispose
      );
  ...
  let m = z(
      (d) => {
        ...
        c(),
          ...
          k().nextFrame(() => {
            var P;
            return (P = n.buttonRef.current) == null
              ? void 0
              : P.focus({ preventScroll: !0 });
          });
      },
    ...
    p = ve(() => ({ active: l, selected: s, disabled: t }), [l, s, t]);
  return E({
    props: {
      ...o,
      ...{
...
var ui = {
    ...
    [2]: (e, t) => {
      ...
      return e.searchQuery === "" && e.activeItemIndex === r
        ? e
        : { ...e, searchQuery: "", activeItemIndex: r };
    },
    [3]: (e, t) => {
      let o = e.searchQuery !== "" ? 0 : 1,
        n = e.searchQuery + t.value.toLowerCase(),
        a = (
          e.activeItemIndex !== null
            ? e.items
                .slice(e.activeItemIndex + o)
                .concat(e.items.slice(0, e.activeItemIndex + o))
            : e.items
        ).find((s) => {
          var u;
          return (
            ((u = s.dataRef.current.textValue) == null
              ? void 0
              : u.startsWith(n)) && !s.dataRef.current.disabled
          );
        }),
        l = a ? e.items.indexOf(a) : -1;
      return l === -1 || l === e.activeItemIndex
        ? { ...e, searchQuery: n }
        : { ...e, searchQuery: n, activeItemIndex: l };
    },
    [4](e) {
    ...
    [5]: (e, t) => {
      var n;
      let r = Array.from(
          (n = e.itemsRef.current) == null
            ? void 0
            : n.querySelectorAll('[id^="headlessui-menu-item-"]')
        ).reduce((i, a, l) => Object.assign(i, { [a.id]: l }), {}),
        o = [...e.items, { id: t.id, dataRef: t.dataRef }].sort(
          (i, a) => r[i.id] - r[a.id]
        );
      return { ...e, items: o };
    },
    [6]: (e, t) => {
      ...
      return (
        n !== -1 && r.splice(n, 1),
        {
          ...
          items: r,
          activeItemIndex: (() =>
            n === e.activeItemIndex || o === null ? null : r.indexOf(o))(),
        }
      );
    },
  },
...
function Ze(e) {
  ...
  w("mousedown", (l) => {
    ...
    let s = l.target;
    r === 0 &&
      (((u = n.current) == null ? void 0 : u.contains(s)) ||
        ((c = o.current) == null ? void 0 : c.contains(s)) ||
        (i({ type: 1 }),
        de(s, 1) ||
          (l.preventDefault(), (m = n.current) == null || m.focus())));
  });
  let a = Xe(() => ({ open: r === 0 }), [r]);
  return Io.createElement(
    ...
    Io.createElement(
      W,
      { value: S(r, { [0]: 0, [1]: 1 }) },
      E({ props: e, slot: a, defaultTag: di, name: "Menu" })
    )
  );
}
var ci = "button",
          ...
          switch (p.key) {
            ...
            case "ArrowDown":
              p.preventDefault(),
                p.stopPropagation(),
                n({ type: 0 }),
                l.nextFrame(() => n({ type: 2, focus: 0 }));
              break;
            case "ArrowUp":
              p.preventDefault(),
                p.stopPropagation(),
                n({ type: 0 }),
                l.nextFrame(() => n({ type: 2, focus: 3 }));
              break;
          }
        },
        [n, l]
  ...
  Ti = D(function (t, r) {
    ...
    let c = Y(
      ...
      b = Xe(() => ({ open: o.menuState === 0 }), [o]),
      T = {
        "aria-activedescendant":
          o.activeItemIndex === null || (p = o.items[o.activeItemIndex]) == null
            ? void 0
            : p.id,
  ...
  yi = Lo;
function gi(e) {
  let { disabled: t = !1, onClick: r, ...o } = e,
    [n, i] = Je("Menu.Item"),
  ...
  x(() => {
    ...
    return (
      p.requestAnimationFrame(() => {
        var f, d;
        (d =
          (f = document.getElementById(a)) == null
            ? void 0
            : f.scrollIntoView) == null || d.call(f, { block: "nearest" });
      }),
      p.dispose
    );
  ...
  x(() => {
    ...
    x(() => {
      ...
      s.current.textValue =
        (f =
          (p = document.getElementById(a)) == null ? void 0 : p.textContent) ==
        null
          ? void 0
          : f.toLowerCase();
    }, [s, a]),
    x(
      () => (i({ type: 5, id: a, dataRef: s }), () => i({ type: 6, id: a })),
      [s, a]
    );
  let u = Y(
      (p) => {
        ...
        if (
          ...
          k().nextFrame(() => {
            var f;
            return (f = n.buttonRef.current) == null
              ? void 0
              : f.focus({ preventScroll: !0 });
          }),
          r)
...
var vi = {
    [0]: (e) => ({ ...e, popoverState: S(e.popoverState, { [0]: 1, [1]: 0 }) }),
    [1](e) {
...
function Te(e) {
  ...
  be(() => l({ type: 3, buttonId: t }), [t, l]),
    be(() => l({ type: 5, panelId: r }), [r, l]);
  let s = Z(
      () => ({ buttonId: t, panelId: r, close: () => l({ type: 1 }) }),
      [t, r, l]
    ),
    u = Fo(),
    ...
    m = j(() => {
      var p;
      return (p = u == null ? void 0 : u.isFocusWithinPopoverGroup()) != null
        ? p
        : (i == null ? void 0 : i.contains(document.activeElement)) ||
            (a == null ? void 0 : a.contains(document.activeElement));
    }, [u, i, a]);
  be(() => (c == null ? void 0 : c(s)), [c, s]),
    w(
      "focus",
      () => {
        n === 0 && (m() || !i || !a || l({ type: 1 }));
    ...
    w("mousedown", (p) => {
      let f = p.target;
      n === 0 &&
        ((i == null ? void 0 : i.contains(f)) ||
          (a == null ? void 0 : a.contains(f)) ||
          (l({ type: 1 }),
  ...
  return Ce.createElement(
    ...
    Ce.createElement(
      ...
      Ce.createElement(
        W,
        { value: S(n, { [0]: 0, [1]: 1 }) },
        E({ props: e, slot: y, defaultTag: Ci, name: "Popover" })
      )
    )
  );
}
var Si = "button",
  Ai = D(function (t, r) {
    let [o, n] = ot("Popover.Button"),
      ...
      c = I(i, r, u ? null : (g) => n({ type: 2, button: g })),
      m = I(i, r),
      b = Se(null),
          ...
          if (u) {
            ...
            switch (g.key) {
              ...
              case "Enter":
                g.preventDefault(),
                  g.stopPropagation(),
                  o.popoverState === 1 && (l == null || l(o.buttonId)),
                  n({ type: 0 });
                break;
              case "Escape":
                if (o.popoverState !== 0)
              ...
              case "Tab":
                ...
                if (g.shiftKey) {
                  if (
                    !T.current ||
                    ((h = o.button) == null ? void 0 : h.contains(T.current)) ||
                    o.panel.contains(T.current)
                  )
                    return;
                  let O = xe(),
      ...
      p = j(
        (g) => {
          ...
          if (
            ...
            o.popoverState === 0 && !!o.panel && !!o.button)
          )
            switch (g.key) {
              case "Tab":
                if (
                  !T.current ||
                  ((v = o.button) == null ? void 0 : v.contains(T.current)) ||
                  o.panel.contains(T.current)
                )
                  return;
                let h = xe(),
      ...
      f = j(
        (g) => {
          ...
          G(g.currentTarget) ||
            t.disabled ||
            (u
              ? (n({ type: 1 }), (v = o.button) == null || v.focus())
              : (o.popoverState === 1 && (l == null || l(o.buttonId)),
                (h = o.button) == null || h.focus(),
                n({ type: 0 })));
        },
        [n, o.button, o.popoverState, o.buttonId, t.disabled, l, u]
      ),
      d = Z(() => ({ open: o.popoverState === 0 }), [o]),
      P = U(t, i),
      C = t,
      R = u
        ? { ref: m, type: P, onKeyDown: y, onClick: f }
        : {
            ref: c,
            id: o.buttonId,
            type: P,
  ...
  Oi = 1 | 2,
  Ii = D(function (t, r) {
    let [{ popoverState: o }, n] = ot("Popover.Overlay"),
      i = I(r),
      ...
      c = Z(() => ({ open: o === 0 }), [o]);
    return E({
      props: { ...t, ...{ ref: i, id: a, "aria-hidden": !0, onClick: u } },
      slot: c,
      defaultTag: hi,
      features: Oi,
      visible: s,
  ...
  Mi = D(function (t, r) {
    ...
    be(() => () => a({ type: 4, panel: null }), [a]),
      be(() => {
        var p;
        t.static ||
          (i.popoverState === 1 &&
            ((p = t.unmount) != null ? p : !0) &&
            a({ type: 4, panel: null }));
      }, [i.popoverState, t.unmount, t.static, a]),
      be(() => {
    ...
    let T = Z(() => ({ open: i.popoverState === 0, close: l }), [i, l]),
      y = { ref: u, id: i.panelId, onKeyDown: b };
    return Ce.createElement(
      Wt.Provider,
      { value: i.panelId },
      E({
...
function wi(e) {
  let t = Se(null),
    ...
    i = j((b) => (o((T) => [...T, b]), () => n(b)), [o, n]),
    a = j(() => {
      var T;
      let b = document.activeElement;
      return ((T = t.current) == null ? void 0 : T.contains(b))
        ? !0
        : r.some((y) => {
            var p, f;
            return (
              ((p = document.getElementById(y.buttonId)) == null
                ? void 0
                : p.contains(b)) ||
              ((f = document.getElementById(y.panelId)) == null
                ? void 0
                : f.contains(b))
            );
          });
  ...
  return Ce.createElement(
    Nt.Provider,
    { value: s },
    E({ props: { ...m, ...c }, slot: u, defaultTag: Fi, name: "Popover.Group" })
  );
}
Te.Button = Ai;
Te.Overlay = Ii;
    ...
    ko(
      () =>
        function (o) {
          ...
          return _i.createElement(_o.Provider, { value: i }, o.children);
        },
      [t]
    ),
  ];
...
function nt(e) {
  let { passive: t = !1, ...r } = e,
    o = Go(),
    n = `headlessui-label-${A()}`;
  x(() => o.register(n), [n, o.register]);
  let i = { ...o.props, id: n },
    a = { ...r, ...i };
  return (
    t && delete a.onClick,
    E({ props: a, slot: o.slot || {}, defaultTag: Ni, name: o.name || "Label" })
  );
}
var Vi = {
    [0](e, t) {
    ...
    [1](e, t) {
      let r = e.options.slice(),
        o = e.options.findIndex((n) => n.id === t.id);
...
var Qi = "div";
function lt(e) {
  let { value: t, onChange: r, disabled: o = !1, ...n } = e,
    [{ options: i }, a] = ji($i, { options: [] }),
    [l, s] = Ae(),
    [u, c] = re(),
    m = `headlessui-radiogroup-${A()}`,
    b = Kt(null),
    T = it(() => i.find((R) => !R.propsRef.current.disabled), [i]),
    y = it(() => i.some((R) => R.propsRef.current.value === t), [i, t]),
    p = ye(
      (R) => {
        var v;
        if (o || R === t) return !1;
        let g =
          (v = i.find((h) => h.propsRef.current.value === R)) == null
            ? void 0
            : v.propsRef.current;
  ...
  let f = ye(
      (R) => {
        if (!b.current) return;
        let v = i
          .filter((h) => h.propsRef.current.disabled === !1)
        ...
        switch (R.key) {
          ...
          case "ArrowUp":
            if ((R.preventDefault(), R.stopPropagation(), M(v, 2 | 16) === 2)) {
              let O = i.find(
                (L) => L.element.current === document.activeElement
              );
          ...
          case " ":
            {
              ...
              let h = i.find(
                (O) => O.element.current === document.activeElement
              );
    ...
    d = ye((R) => (a({ type: 0, ...R }), () => a({ type: 1, id: R.id })), [a]),
    P = it(
      () => ({
        registerOption: d,
        firstOption: T,
  ...
  return he.createElement(
    ...
    he.createElement(
      ...
      he.createElement(
        jt.Provider,
        { value: P },
        E({ props: { ...n, ...C }, defaultTag: Qi, name: "RadioGroup" })
      )
    )
  );
}
...
function zi(e) {
  let t = Kt(null),
    r = `headlessui-radiogroup-option-${A()}`,
    [o, n] = Ae(),
    [i, a] = re(),
    { addFlag: l, removeFlag: s, hasFlag: u } = wo(1),
    { value: c, disabled: m = !1, ...b } = e,
    T = Kt({ value: c, disabled: m });
  x(() => {
    T.current.value = c;
  }, [c, T]),
    x(() => {
  ...
  let R = ye(() => {
    ...
    K = it(() => ({ checked: L, disabled: O, active: u(2) }), [L, O, u]);
  return he.createElement(
    a,
    { name: "RadioGroup.Description" },
    he.createElement(
...
function ol(e) {
  let [t, r] = Zi(null),
    ...
    [i, a] = re(),
    l = Uo(
      () => ({ switch: t, setSwitch: r, labelledby: o, describedby: i }),
      [t, r, o, i]
    );
  return Vt.createElement(
    ...
    Vt.createElement(
      ...
      Vt.createElement(
        $t.Provider,
        { value: l },
        E({ props: e, defaultTag: tl, name: "Switch.Group" })
      )
    )
  );
}
var rl = "button";
function Qt(e) {
  let { checked: t, onChange: r, ...o } = e,
    n = `headlessui-switch-${A()}`,
    i = Ji($t),
    a = el(null),
    l = I(a, i === null ? null : i.setSwitch),
    s = at(() => r(!t), [r, t]),
    u = at(
      (y) => {
...
function cl(e) {
  let {
    ...
    m = Oe(() => ({ selectedIndex: u.selectedIndex }), [u.selectedIndex]),
    b = st(() => {});
  Ie(() => {
    ...
    Ie(() => {
      ...
      let p = u.tabs.map((P) => P.current).filter(Boolean),
        ...
        d = i != null ? i : t;
      if (d < 0) c({ type: 0, index: p.indexOf(f[0]) });
  ...
  return nl.createElement(
    zt.Provider,
    { value: y },
    E({ props: { ...a }, slot: m, defaultTag: dl, name: "Tabs" })
  );
}
var fl = "div";
function ml(e) {
  let [{ selectedIndex: t, orientation: r }] = Le("Tab.List"),
    o = { selectedIndex: t };
  return E({
    props: { ...e, ...{ role: "tablist", "aria-orientation": r } },
    slot: o,
    defaultTag: fl,
    name: "Tabs.List",
  });
...
function De(e) {
  ...
  let t = `headlessui-tabs-tab-${A()}`,
    [
      { selectedIndex: r, tabs: o, panels: n, orientation: i, activation: a },
      { dispatch: l, change: s },
    ] = Le(De.name),
    u = st(null),
    c = I(u, (g) => {
  ...
  let m = o.indexOf(u),
    ...
    d = {
      ...
      type: U(e, u),
      "aria-controls":
        (R = (C = n[m]) == null ? void 0 : C.current) == null ? void 0 : R.id,
      "aria-selected": b,
      tabIndex: b ? 0 : -1,
    };
  return E({
...
var Tl = "div";
function yl(e) {
  let [{ selectedIndex: t }] = Le("Tab.Panels"),
    r = Oe(() => ({ selectedIndex: t }), [t]);
...
function xl(e) {
  var T, y;
  let [{ selectedIndex: t, tabs: r, panels: o }, { dispatch: n }] =
      Le("Tab.Panel"),
  ...
  let s = o.indexOf(a),
    ...
    m = {
      ...
      role: "tabpanel",
      "aria-labelledby":
        (y = (T = r[s]) == null ? void 0 : T.current) == null ? void 0 : y.id,
      tabIndex: u ? 0 : -1,
    };
  return E({
    props: { ...e, ...m },
...
import { useRef as vl, useEffect as Rl } from "react";
function Bo() {
  let e = vl(!0);
  return (
    Rl(() => {
...
function El(e, t) {
  ...
  let { transitionDuration: o, transitionDelay: n } = getComputedStyle(e),
    [i, a] = [o, n].map((l) => {
      let [s = 0] = l
        .split(",")
        .filter(Boolean)
...
function Xt(e, t, r, o, n, i) {
  ...
  return (
    ...
    a.nextFrame(() => {
      ut(e, ...r),
        Yt(e, ...o),
        a.add(El(e, (s) => (ut(e, ...o, ...t), Yt(e, ...n), l(s))));
    }),
    a.add(() => ut(e, ...t, ...r, ...o, ...n)),
    a.add(() => l("cancelled")),
    a.dispose
...
function le(e = "") {
  return Zt(() => e.split(" ").filter((t) => t.trim().length > 1), [e]);
}
var dt = Ko(null);
      ...
      (a) => {
        ...
        return (
          l
            ...
            : r.current.push({ id: a, state: "visible" }),
          () => n(a, 0)
        );
      },
      [r, n]
    );
  return Zt(() => ({ children: r, register: i, unregister: n }), [i, n, r]);
}
function Al() {}
...
function zo(e) {
  let {
    ...
    [y, p] = Vo("visible"),
    f = b.unmount ? 0 : 1,
    { show: d, appear: P, initial: C } = Cl(),
    { register: R, unregister: g } = Sl(),
    v = A(),
    h = Me(!1),
    O = $o(() => {
  ...
  let L = le(i),
    ...
    ge = le(c),
    we = le(m),
    X = Ol({ beforeEnter: t, afterEnter: r, beforeLeave: o, afterLeave: n }),
    F = q();
  pt(() => {
  ...
  x(() => {
    ...
    if (!!bt && !$)
      return (
        (h.current = !0),
        d && X.current.beforeEnter(),
        d || X.current.beforeLeave(),
        d
          ? Xt(bt, L, N, K, V, (Tt) => {
          ...
          : Xt(bt, Fe, ge, we, V, (Tt) => {
              (h.current = !1),
                Tt === "finished" &&
                  (ft(O) || (p("hidden"), g(v), X.current.afterLeave()));
            })
      );
...
function mt(e) {
  let { show: t, appear: r = !1, unmount: o, ...n } = e,
    i = _();
  if (
    (t === void 0 && i !== null && (t = S(i, { [0]: !0, [1]: !1 })),
    ![!0, !1].includes(t))
  )
    throw new Error(
      "A <Transition /> is used but it is missing a `show={true | false}` prop."
    );
  let [a, l] = Vo(t ? "visible" : "hidden"),
    s = $o(() => {
      l("hidden");
    }),
    u = Bo(),
    c = Zt(() => ({ show: t, appear: r || !u, initial: u }), [t, r, u]);
  pt(() => {
  ...
  return ie.createElement(
    ...
    ie.createElement(
      ...
      { value: c },
      E({
        props: { ...m, as: Wo, children: ie.createElement(zo, { ...m, ...n }) },
        defaultTag: Wo,
        features: qo,
        visible: a === "visible",
        name: "Transition",
...
mt.Child = function (t) {
  let r = Jt(dt) !== null,
    o = _() !== null;
  return !r && o
    ? ie.createElement(mt, { ...t })
    : ie.createElement(zo, { ...t });
};
mt.Root = mt;
export {
  Na as Combobox,
