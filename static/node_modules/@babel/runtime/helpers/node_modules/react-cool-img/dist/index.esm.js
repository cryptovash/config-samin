...
var Imager = /*#__PURE__*/ (function () {
  ...
  _proto.load = function load(src, decode, _ref, onError, onLoad, crossOrigin) {
    ...
    if (decode && this.img.decode)
      this.img.decode()["catch"](function () {
    ...
    this.img.onerror = function (event) {
      ...
      var time =
        acc === "*" ? Math.pow(delay, _this.retries) : delay * _this.retries;
...
var Img = /*#__PURE__*/ forwardRef(function (_ref, ref) {
  var _ref$className = _ref.className,
    ...
    observerOptions =
      _ref$observerOptions === void 0 ? {} : _ref$observerOptions,
  ...
  var _useState = useState(placeholder || DEFAULT_SRC),
    source = _useState[0],
  ...
  useEffect(
    function () {
      ...
      if (!lazy || (cache && get(src)) || startLoad)
        imager.load(
          src,
          decode,
          retry,
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        "style",
        null,
        ".no-js-" + filename + " { display: none !important; }"
      ),
      /*#__PURE__*/ React.createElement(
        "img",
        _extends(
